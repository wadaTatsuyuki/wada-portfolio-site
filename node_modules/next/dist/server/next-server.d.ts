...
import BaseServer, { Options, FindComponentsResult, MiddlewareRoutingItem, RequestContext, NormalizedRouteManifest } from 'next/dist/server/base-server';
...
export default class NextNodeServer extends BaseServer {
    ...
    protected renderHTML(req: NodeNextRequest, res: NodeNextResponse, pathname: string, query: NextParsedUrlQuery, renderOpts: import('next/dist/server/render').RenderOpts): Promise<RenderResult>;
